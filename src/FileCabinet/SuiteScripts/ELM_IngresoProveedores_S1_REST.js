...
define(['N/search', "./SDB-Enlamano-score.js", 'N/runtime', "./ELM_Aux_Lib.js", 'N/record', './ELM_SCORE_BCU_LIB.js', 'N/log'],
   function (search, scoreLib, runtime, auxLib, record, bcuScoreLib) { 
      ...
      function post(requestBody) {
         ...
         log.debug('RESTlet working', 'Documento: ' + docNumber + ' - Nombre: ' + firstName +
            ' - Apellido: ' + lastName + ' - Actividad: ' + activityType +
            ' - Salario: ' + salary + ' - Fecha de Nacimiento: ' + dateOfBirth
            + ' - Fecha de Ingreso Laboral: ' + workStartDate + ' - Fuente: ' + source);
         const response = {
            docNumber: docNumber,
            success: false,
